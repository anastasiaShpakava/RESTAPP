...
@AllArgsConstructor
@Entity
public class PasswordResetToken { // При срабатывании сброса пароля будет создан токен, и пользователю будет отправлена ​​специальная ссылка, содержащая этот токен.
